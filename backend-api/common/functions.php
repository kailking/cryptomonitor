...
function get_exchange_api($platform){
    switch ($platform){
        ...
        case CurrencyQuotation::PLATFORM_KUCOIN:
            ...
            break;
        case CurrencyQuotation::PLATFORM_DF:
            return new \App\Service\Exchanges\Ascend();
        default:
            return null;
...
function get_by_proxy($Url){
    ...
    $proxyServer = config('services.bishuju_proxy.url');
    ...
    curl_setopt($ch, CURLOPT_PROXYUSERPWD, config('services.bishuju_proxy.credentials'));
